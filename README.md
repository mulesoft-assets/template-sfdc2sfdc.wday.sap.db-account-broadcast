...
As a Salesforce admin I want to synchronize accounts from a Salesforce Org to another Salesforce Org, Workday Org, a SAP system a Database.
...
1. The batch will fail, if you do not provide correct value for Workday Customer Category Id. You will need to extend the custom mapping, if accounts with a different than five mapped Salesforce Industry / Workday Customer Category values are updated.
